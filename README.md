...
The aim of this project is to create an API in Falsk to create conversations between different users in a chat. In the SRC folder, you can find different files with the necessary code to implement the API. 
...
-recommender.py: code to implement a recommendation system for the users
